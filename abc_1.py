...
# --- S-Laser + Camera (both as part of SCANNER; move to SPx) ---
...
async function refresh(){
  try{
    ...
    renderInfo(state); renderStatus(state); renderCoords(state); renderPT(state); renderBladeCounter(state); renderSchematic(state);
